...
import CostHeatmap from '../plugins/cost-heatmap/widget'
import CronManager from '../plugins/cron-manager/widget'
import ExchangeRate from '../plugins/exchange-rate/widget'
import Flashcards from '../plugins/flashcards/widget'
import JobSearch from '../plugins/job-search/widget'
import OMADTracker from '../plugins/omad-tracker/widget'
import ProjectUpdates from '../plugins/project-updates/widget'
import SystemMonitor from '../plugins/system-monitor/widget'
import VoiceNotes from '../plugins/voice-notes/widget'
import VoiceToText from '../plugins/voice-to-text/widget'
import Wellbeing from '../plugins/wellbeing/widget'
